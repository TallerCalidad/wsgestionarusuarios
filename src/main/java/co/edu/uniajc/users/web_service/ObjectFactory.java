 ...
 * generated in the co.edu.uniajc.users.web_service package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: co.edu.uniajc.users.web_service
     * 
     */
